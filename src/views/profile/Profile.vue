<template>
  <div id="profile">
    ...
    <UserInfo>
      <!-- 在使用 slot时需要注意，指定slot值的标签会直接代替组件中的slot标签，如果组件中slot设置了class，那么使用slot时也需要指明class -->
      <img slot="user-icon" src="~/@/assets/img/profile/userImg.png" class="privateImage-svg left">
      <div slot="user-nickname" style="font-weight: 700; font-size: 20px">ChangingTao</div>
    </UserInfo>
